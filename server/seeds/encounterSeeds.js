...
const encounter = [
  ...
  {
    story: "Sorry boss, I dont have an image or data for this upcoming encounter so heres some asteroids",
  ...
  },
  {
    ...
    message: "You’ve come across an abandoned ship, salvage supplies for your ship.",
  ...
  {
    story: "That was awesome, I've never seen so many robots on one planet! We have to keep moving, lets go!.",
  ...
  },
  {
    ...
    message:"You’ve made it to Niburu, luckily their currency the Mana, at an exchange rate of 1/1 with gold. Would you like to pay for repairs?’",
  ...
  {
    story:   "Get ready for a rough landing, the radar is'nt detecting this planet. This doesn't look good!",
  ...
  {
    story: "Glad we made it to Peter's Pass, I was looking forward to checking this place out. A particularly scenic part of space, Peter’s Pass is littered with beautiful stars, and a black hole a safe distance away. It’s beauty brings space travellers from all planets to visit and enjoy the breathtaking scenery.",
  ...
  },
  {
    ...
    message: 'Sir Isaac Henry Kentsworth IV, a seasoned explorer himself (in an endless search for the best Serpent Breeds, and Growing Techniques) informs you of of a shortcut that requires passing through a porthole owned by the Space Trolls. Avid fans of Trivia, a successful attempt at their trivia game allows passage that avoids a dangerous and hostile set of planets, but be warned, failure will result in the loss of your ship. A deadly price. Which path do you wish to take?',
    option1: 'Fight back|{"health": 0, "ship": -10, "gold": -10, "next": "minigame/asteroids", "next_location_id": 10}',
    option2: 'Go Around|{"health": 0, "ship": -10, "gold": -10, "next": "results", "next_location_id": 10}',
    location_id: 11,
  },
  ...
  //may come after decline option from troll (encounter 12)
    ...
    message: 'his is a dangerous part of space, no way around it anymore. Many expolorers choose to push their ships to the max to try and avoid Moon Pirates. Do you wish to do the same?',
    option1: 'Fight back|{"health": 0, "ship": -10, "gold": -10, "next": "minigame/asteroids", "next_location_id": 10}',
    option2: 'Go Around|{"health": 0, "ship": -10, "gold": -10, "next": "results", "next_location_id": 10}',
    location_id: 14,
  },
...
},
  {
    ...
    message: 'You’ve made it to Quishuang’s Planet. Luckily their currency, has an exchange rate of 2.5/1 with gold. Would you like to pay for repairs?',
    option1: 'Fight back|{"health": 0, "ship": -10, "gold": -10, "next": "minigame/asteroids", "next_location_id": 10}',
    option2: 'Go Around|{"health": 0, "ship": -10, "gold": -10, "next": "results", "next_location_id": 10}',
    location_id: 16,
  },
  {
    ...
    message: 'Aware of their surroundings, the Space Force on Quishuang’s Planet is extremely well developed, and offer travellers the oportunity for an escorted trip to Terminus (the last stop before Earth) for 40 Gold, do you wish to Take this trip?',
    option1: 'Fight back|{"health": 0, "ship": -10, "gold": -10, "next": "minigame/asteroids", "next_location_id": 10}',
    option2: 'Go Around|{"health": 0, "ship": -10, "gold": -10, "next": "results", "next_location_id": 10}',
    location_id: 17,
  },
