...
export const ROIDS_JAG = 0; // jaggedness of the asteroids (0 = none, 1 = lots)
...
export const ROIDS_SPD = 4; // max starting speed of asteroids in pixels per sec
export const ROIDS_VERT = 50; // average number of vertices on each asteroid
...
export const HIT_DAMAGE = 5; // damage when hit by an asteroid
