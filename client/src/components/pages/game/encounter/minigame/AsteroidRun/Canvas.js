...
import { drawAsteroids, createAsteroids, moveAsteroids, makeAsteroidsMoveLeft } from "../Asteroids/AstroidMovement";
import { detectExploding, detectHit, drawShipLives, drawTimer, gameOver } from "../Asteroids/helper";
...
const Canvas = ({ setGameProcess, setGameResult }) => {
  ...
  useLayoutEffect(() => {
    ...
    const myRender = () => {
      ...
      moveAsteroids(ctx, roids.current, 2, 1);
